    ...
    for (let sIdx = 0; sIdx < seeds.length; sIdx++) {
      ...
      for (let t = 0; t < trialsPerSeed; t++) {
        ...
        for (let step = 0; step < 320; step++) {
          ...
          if (game.fly.swingAttempted || game.ai.attempted) {
            contactMade = true;
          }
...
async function main() {
  ...
  console.log("=== CLASSIC EASY ===");
  await runStressBenchmark(
    "CLASSIC EASY",
    { opponentType: "classic", difficulty: "easy" },
    null,
    100,
  );
  ...
  await runStressBenchmark(
    "CLASSIC NORMAL",
    { opponentType: "classic", difficulty: "normal" },
    null,
    100,
  );
  ...
  console.log("\n=== FLY CASUAL ===");
  await runStressBenchmark(
    "FLY CASUAL (DEMO ASSIST)",
    { opponentType: "fruitfly", flyEmbodimentMode: "demo-assist" },
    null,
    100,
  );
  ...
  await runStressBenchmark(
    "FLY SCIENTIFIC",
    { opponentType: "fruitfly", flyEmbodimentMode: "scientific" },
    null,
    100,
  );
}
